...
trainingSet = csvread(strcat(fileparts(mfilename('fullpath')), "/../data/08FebSimMatchesByResult//train.csv"));
...
testSet = csvread(strcat(fileparts(mfilename('fullpath')), "/../data/08FebSimMatchesByResult//test.csv"));
...
betterThanBookies = 0.1; %has to be this amount better than betters probabilities
