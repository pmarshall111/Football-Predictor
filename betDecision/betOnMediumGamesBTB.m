function [totalReturn, totalSpent, profit, percentageProfit, numbBets, betMatrix, resultsToBetOn] = betOnMediumGamesBTB(betProbs, ourProbs, y, betterThanBookiesBy)
  ...
  diffBetweenHomeAway = abs(betProbs(:,1:1) - betProbs(:,3:3));
  closeGames = diffBetweenHomeAway < 0.8 && diffBetweenHomeAway > 0.25;
