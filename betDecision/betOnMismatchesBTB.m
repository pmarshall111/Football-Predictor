function [totalReturn, totalSpent, profit, percentageProfit, numbBets, betMatrix, resultsToBetOn] = betOnMismatchesBTB(betProbs, ourProbs, y, betterThanBookiesBy)
  ...
  closeGames = abs(betProbs(:,1:1) - betProbs(:,3:3)) > 0.8;
